      ...
      <div className="relative w-full max-w-[420px] bg-white rounded-3xl p-6 sm:p-8 shadow-2xl z-10 animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            ...
            className="w-full py-3 bg-white border border-neutral-200 text-neutral-700 text-xs sm:text-sm font-medium rounded-xl hover:bg-neutral-50 transition-colors flex items-center justify-center gap-2.5 shadow-2xs disabled:opacity-60 active:scale-[0.99]"
          >
            {googleLoading ? (
            ...
            <span>{googleLoading ? 'Google\'a yönlendiriliyor...' : 'Google ile giriş yap'}</span>
          </button>
        </form>
      </div>
    </div>
