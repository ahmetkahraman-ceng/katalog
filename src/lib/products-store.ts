...
export const INITIAL_PRODUCTS: StoredProduct[] = [
  {
    ...
    images: [
      {
        url: 'https://images.unsplash.com/photo-1597463510526-9f1e1a49f16b?q=80&w=1000&auto=format&fit=crop',
    ...
    variants: [
      {
        ...
        variantName: 'Ham Bej',
        variantType: 'Renk',
        imageUrl: 'https://images.unsplash.com/photo-1597463510526-9f1e1a49f16b?q=80&w=1000&auto=format&fit=crop',
        sortOrder: 0,
      },
      {
        id: 'var-el-2',
  ...
  {
    id: 'prod-sirt-antrasit',
    name: 'Antrasit Executive Korumalı Laptop Sırt Çantası',
    slug: 'antrasit-executive-korumali-laptop-sirt-cantasi',
    sku: 'SRT-004',
    minOrderQty: 50,
    description: 'Koyu antrasit melanj kumaş, mavi fermuar elcikli, deri takviyeli tabanlı ve 15.6 inç darbe emici süngerli korumalı kurumsal sırt çantası. Çift fermuarlı ana bölme ve ön organizatör cepleri.',
    priceMin: 280,
    priceMax: 390,
    colors: ['Antrasit', 'Siyah', 'Lacivert'],
    badge: 'Yeni',
    tags: ['Sırt Çantası', 'Laptop', 'Executive', 'Promosyon'],
    featured: true,
    status: 'ACTIVE',
    ...
    images: [
      {
        ...
        alt: 'Antrasit Executive Korumalı Laptop Sırt Çantası',
        order: 0,
      },
    ],
    specs: [
      { specKey: 'Kumaş', specValue: 'Su İtici Antrasit Melanj Kumaş', sortOrder: 0 },
      { specKey: 'Laptop Bölmesi', specValue: '15.6 inç Darbe Korumalı Sünger Haznesi', sortOrder: 1 },
      { specKey: 'Taban', specValue: 'Deri Takviyeli Yıpranmaz Taban', sortOrder: 2 },
      { specKey: 'Minimum Sipariş', specValue: '50 Adet (Baskılı)', sortOrder: 3 },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'prod-sirt-bosch',
    name: 'Ergonomik Çift Renkli Promosyon Sırt Çantası',
    slug: 'ergonomik-cift-renkli-promosyon-sirt-cantasi',
    sku: 'SRT-003',
    minOrderQty: 50,
    description: 'Yeşil ve siyah kontrast gövde, kavisli geniş ön bölme, yüksek kaliteli kurumsal logo nakış ve baskı alanı. Çift yan file matara cebi ve takviyeli ergonomik sırt askıları.',
    priceMin: 220,
    priceMax: 310,
    colors: ['Yeşil-Siyah', 'Lacivert-Siyah', 'Kırmızı-Siyah'],
    badge: 'Popüler',
    tags: ['Sırt Çantası', 'Promosyon Sırt Çantası', 'Kurumsal Hediye'],
    featured: true,
    status: 'ACTIVE',
    categoryId: 'sirt-cantasi',
    category: {
    ...
    images: [
      {
        ...
        alt: 'Ergonomik Çift Renkli Promosyon Sırt Çantası',
        order: 0,
      },
    ],
    specs: [
      { specKey: 'Kumaş', specValue: '600D Kalın Su İtici İmperteks', sortOrder: 0 },
      { specKey: 'Cebler', specValue: 'Geniş ön cep, 2 yan elastik file cep', sortOrder: 1 },
      { specKey: 'Baskı Seçenekleri', specValue: 'Nakış, Kauçuk Etiket, Transfer Baskı', sortOrder: 2 },
  ...
  {
    id: 'prod-sirt-bordo',
    name: 'Promosyon Bordo Okul & Kurs Sırt Çantası',
    slug: 'promosyon-bordo-okul-kurs-sirt-cantasi',
    sku: 'SRT-001',
    minOrderQty: 50,
    description: 'Bordo renkli dayanıklı kumaş, okullar, kolejler, kurslar ve üniversiteler için kurumsal logo baskılı promosyon sırt çantası. Fermuarlı ön cep ve geniş iç hacim.',
    priceMin: 175,
    priceMax: 240,
    colors: ['Bordo', 'Siyah', 'Lacivert', 'Haki'],
    badge: 'Popüler',
    tags: ['Sırt Çantası', 'Okul Çantası', 'Promosyon', 'Baskılı Sırt Çantası'],
    featured: true,
    status: 'ACTIVE',
    categoryId: 'sirt-cantasi',
    category: {
    ...
    images: [
      {
        ...
        alt: 'Promosyon Bordo Okul & Kurs Sırt Çantası',
        order: 0,
      },
    ],
    specs: [
      { specKey: 'Kumaş', specValue: 'Yırtılmaz 600D İmperteks', sortOrder: 0 },
      { specKey: 'Kapasite', specValue: '20 Litre Geniş İç Hacim', sortOrder: 1 },
      { specKey: 'Baskı', specValue: 'İpek Serigrafi veya Renkli DTF Transfer', sortOrder: 2 },
      { specKey: 'Minimum Sipariş', specValue: '50 Adet', sortOrder: 3 },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  {
    id: 'prod-sirt-haki',
    name: 'Özel Desen Baskılı Promosyon Sırt Çantası (Haki)',
    slug: 'ozel-desen-baskili-promosyon-sirt-cantasi-haki',
    sku: 'SRT-002',
    minOrderQty: 50,
    description: 'Haki zemin üzerine firmanızın sektörüne veya temasına özel tüm yüzey desen baskılı promosyon sırt çantası. Yan file suluk cepleri ve fermuarlı geniş ön bölme.',
    priceMin: 190,
    priceMax: 260,
    colors: ['Haki', 'Siyah', 'Gri'],
    badge: 'Yeni',
    tags: ['Sırt Çantası', 'Desen Baskılı', 'Promosyon', 'Özel İmalat'],
    featured: true,
    status: 'ACTIVE',
    categoryId: 'sirt-cantasi',
    category: {
    ...
    images: [
      {
        ...
        alt: 'Özel Desen Baskılı Promosyon Sırt Çantası (Haki)',
        order: 0,
      },
    ],
    specs: [
      { specKey: 'Kumaş', specValue: 'Özel Desen Baskılı İmperteks Kumaş', sortOrder: 0 },
      { specKey: 'Bölmeler', specValue: 'Fermuarlı ana bölme, ön cep, yan fileler', sortOrder: 1 },
      { specKey: 'Özel Tasarım', specValue: 'Firmanıza özel desen ve logo yerleşimi', sortOrder: 2 },
      { specKey: 'Minimum Sipariş', specValue: '50 Adet', sortOrder: 3 },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  {
    id: 'prod-sirt-kirmizi',
    name: 'Dinamik Kırmızı-Neon Promosyon Sırt Çantası',
    slug: 'dinamik-kirmizi-neon-promosyon-sirt-cantasi',
    sku: 'SRT-005',
    minOrderQty: 50,
    description: 'Canlı kırmızı gövde, neon lime fermuar şeritleri ve elcikleri ile genç ve dinamik spor/etkinlik sırt çantası. Dikey ön cep ve yan file matara bölmesi.',
    priceMin: 160,
    priceMax: 220,
    colors: ['Kırmızı-Neon', 'Siyah-Neon', 'Mavi-Neon'],
    badge: 'Yeni',
    tags: ['Sırt Çantası', 'Spor Çantası', 'Promosyon', 'Dinamik'],
    featured: true,
    status: 'ACTIVE',
    categoryId: 'sirt-cantasi',
    category: {
    ...
    images: [
      {
        url: '/products/sirt-canta-kirmizi-neon.png',
        alt: 'Dinamik Kırmızı-Neon Promosyon Sırt Çantası',
        order: 0,
      },
    ],
    specs: [
      { specKey: 'Kumaş', specValue: 'Hafif ve Su İtici İmperteks', sortOrder: 0 },
      { specKey: 'Fermuar', specValue: 'Neon Renkli Tip 5 Fermuar Şeritleri', sortOrder: 1 },
